...
public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, Response.ErrorListener, Response.Listener<List<MainSlider>> {
    ...
    private void initData() {
        String url = "http://www.newsmth.net/mainpage.html";
